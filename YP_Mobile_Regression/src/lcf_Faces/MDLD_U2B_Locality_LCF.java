...
//8
public class MDLD_U2B_Locality_LCF extends DriverScript implements Locators {

int f;
	
	@Test()
	
	public void MDLD_U2B_Locality_LCF() throws InterruptedException, Exception, IOException  {
	    ...
	    driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	    	...
	    	String t1= driver.findElement(By.xpath("html/body/div[4]/section/div/div/div[1]/div[2]/div/div[1]/div/div[2]/div[2]/ul/li[1]/label")).getText();
	    	System.out.println(t1);
    		Reporter.log(t1);
    		driver.findElement(By.xpath("html/body/div[4]/section/div/div/div[1]/div[2]/div/div[1]/div/div[2]/div[2]/ul/li[1]/label")).click();
    		
	    	Thread.sleep(3000);
	   
	    	driver.findElement(By.xpath("html/body/div[4]/section/div/div/div[1]/div[3]/button[2]")).click();
	    	Thread.sleep(3000);
	    	
driver.findElement(By.xpath("html/body/div[4]/section/div/div/div[1]/div[2]/div/div[2]/div/div[2]/div[2]/ul/li[1]/label")).click();    		
	    	Thread.sleep(3000);	   
	    	driver.findElement(By.xpath("html/body/div[4]/section/div/div/div[1]/div[2]/div/div[3]/div/div[2]/div[2]/ul/li[1]/label")).click();
	    	Thread.sleep(3000);	   
	    	driver.findElement(By.xpath("html/body/div[4]/section/div/div/div[1]/div[3]/button[2]")).click();
	    	
	    	driver.findElement(By.xpath("html/body/div[4]/section/div/div/div[1]/div[2]/div/div[4]/div/div[2]/div[2]/ul/li[1]/label")).click();
	    	Thread.sleep(3000);	   
	    	driver.findElement(By.xpath("html/body/div[4]/section/div/div/div[1]/div[3]/button[2]")).click();
	    	Thread.sleep(3000);	   
...
//Select locality
	    ...
	    try{
	    	...
	    	WebElement e1=driver.findElement(By.xpath("//div[2]/div[2]/div/div/div/div[2]/div[3]/ul/li[3]/label"));
	    	String s1=e1.getText();
	    	e1.click();
	    	Thread.sleep(3000);
	    //	loc.click();
	    	Thread.sleep(3000);
	    	WebElement e2=driver.findElement(By.xpath("//div[2]/div[2]/div/div/div/div[2]/div[3]/ul/li[4]/label"));
	    	String s11=e2.getText();
	    	e2.click();
	    	Thread.sleep(2000);
	    	driver.findElement(By.xpath("//div/div[2]/div[2]/div/div/div/div[2]/a")).click();
	    	
	   	  	if(loc.getText().contains(s11)&& loc.getText().contains(s11)){
