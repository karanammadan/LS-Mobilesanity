...
//29
public class SDLD_SEMpage extends DriverScript implements Locators {
	
int f=0;
	
	@Test()
	
	public void SDLD_SEMpage() throws Exception, IOException {
		
		/*File src = new File("D:\\Harish\\Yellowpage_2\\mobLCFsanity.xls");
		Workbook wb=Workbook.getWorkbook(src);
		String url=wb.getSheet(0).getCell(1, 18).getContents();
		System.out.println(url);*/
		
		String url="http://www.sulekha.com/housekeeping-services/chennai?pagetype=sem";
		Reporter.log(url);
	...
	//Select Need	
		String s2=driver.findElement(By.xpath("//label[@for='smulti2']")).getText();
