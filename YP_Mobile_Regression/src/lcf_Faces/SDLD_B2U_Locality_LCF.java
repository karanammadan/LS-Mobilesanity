...
//17
public class SDLD_B2U_Locality_LCF extends DriverScript implements Locators {
...
int f;
	...
	public void lcfposting() throws InterruptedException, Exception, IOException  {
		...
		String url="http://www.sulekha.com/pest-control-services/chennai";
...
//Select locality
	    ...
	    try{
	    	...
	    	loc.click();
	    	Thread.sleep(3000);
	    	WebElement e2=driver.findElement(By.xpath("html/body/div[4]/section/div/div/div[2]/div[2]/div/div/div/div[2]/div[3]/ul/li[3]/label"));
